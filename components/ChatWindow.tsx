...
// export default function ChatWindow({ currentUser, otherUser, messages, setMessages, socket }: ChatWindowProps) {
...
//     socket.on("typing-start-to-client", (typingUserId: string) => {
//       if (typingUserId === otherUser) setIsPartnerTyping(true);
//     });

//     socket.on("typing-stop-to-client", (typingUserId: string) => {
//       if (typingUserId === otherUser) setIsPartnerTyping(false);
//     });
...
//     socket.emit("typing-stop", { roomId: msgData.roomId, senderId: currentUser });
//     setInputMessage("");
//   };
...
//       {/* Header */}
//       <header className="p-4 border-b bg-blue-50 flex justify-between items-center">
//         <div>
//           <h3 className="text-xl font-bold text-gray-800">
//             Chatting with: <span className="text-blue-600">{otherUser}</span>
//           </h3>
//           {isPartnerTyping && <p className="text-xs text-green-500 font-bold animate-pulse">typing...</p>}
//         </div>
//       </header>
...
//         <input
//           type="text"
//           className="flex-1 border border-gray-300 p-3 rounded-l-xl text-black focus:outline-none focus:border-blue-500"
...
//           className="px-6 py-3 bg-blue-600 text-white font-bold rounded-r-xl hover:bg-blue-700 transition"
//         >
//           Send
//         </button>
//       </div>
